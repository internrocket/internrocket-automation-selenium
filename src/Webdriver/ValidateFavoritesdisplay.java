...
public class ValidateFavoritesdisplay {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.id("favorit")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("projectfavorite")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("userfavorite")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("companyfavorite")).click();
