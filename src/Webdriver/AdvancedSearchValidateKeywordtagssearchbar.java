...
public class AdvancedSearchValidateKeywordtagssearchbar {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@id=\"view\"]/div[4]/div[2]/div/div[1]/div[4]/div/div[4]/div/div[2]/tags-input/div/div/input")).sendKeys("css,html,angularjs");
        Thread.sleep(5000);
