...
public class DiscoverpeopleValidateFavoritebuttononuserprofiles {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.id("dispeople")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("userpeople")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("favoriteclick")).click();
