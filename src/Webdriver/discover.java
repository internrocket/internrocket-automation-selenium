...
public class discover {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.id("dispostings")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("dismicro")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("disinter")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("diaapprent")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("disjob")).click();
