...
public class AdvancedSearchValidateinudstrysearchbarcompanies {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);
        driver.findElement(By.xpath("//*[@id=\"view\"]/div[4]/div[2]/div/div[1]/div[4]/div/div[4]/div/div[1]/tags-input/div/div/input")).sendKeys("ites");
        Thread.sleep(5000);
        //driver.findElement(By.id("networkclick")).click();
        //Thread.sleep(5000);
       driver.findElement(By.xpath("//*[@id=\"view\"]/div[4]/div[2]/div/div[1]/div[4]/div/div[4]/div/div[1]/tags-input/div/auto-complete/div/ul/li")).click();
       Thread.sleep(5000);
