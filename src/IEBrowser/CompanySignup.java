...
public class CompanySignup {
    ...
    Thread.sleep(2000);
    driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div/div/section/article/div/div[2]/div/div/div[1]/div[4]/div/div/div/div/div/form/input[1]")).sendKeys("TECHNO26");
    Thread.sleep(2000);
    driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div/div/section/article/div/div[2]/div/div/div[1]/div[4]/div/div/div/div/div/form/input[2]")).sendKeys("Degala26");
    Thread.sleep(2000);
    driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/div/div/section/article/div/div[2]/div/div/div[1]/div[4]/div/div/div/div/div/form/input[3]")).sendKeys("degala26@yopmail.com");
    Thread.sleep(2000);
    ...
    Thread.sleep(3000);
    driver.findElement(By.id("name")).sendKeys("Angular4PHP5");
    Thread.sleep(3000);
